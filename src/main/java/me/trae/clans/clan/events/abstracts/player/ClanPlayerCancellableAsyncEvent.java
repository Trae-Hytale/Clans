...
@Getter
public class ClanPlayerCancellableAsyncEvent extends ClanCancellableAsyncEvent implements IClanPlayerEvent {

    private final PlayerRef player;
    private final Client playerClient;

    public ClanPlayerCancellableAsyncEvent(final Clan clan, final PlayerRef player, final Client playerClient) {
        super(clan);

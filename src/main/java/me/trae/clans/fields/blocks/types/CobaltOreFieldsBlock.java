...
@Component
public class CobaltOreFieldsBlock implements FieldsBlock {

    @Override
    public List<String> getBlockIds() {
        return List.of("Ore_Cobalt_Shale", "Ore_Cobalt_Slate");
    }

    @Override
    public List<Loot> getLootList() {
        return List.of(new StaticQuantityItemLoot("Ingredient_Bar_Cobalt", 1));
    }
